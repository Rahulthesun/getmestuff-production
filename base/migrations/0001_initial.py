# Generated by Django 4.2.13 on 2024-07-10 22:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('funded_percent', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('supporters', models.IntegerField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('donation_amount', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
